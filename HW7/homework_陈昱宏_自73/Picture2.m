% 读取原图并分割左右眼
I = imread('./Data/eye2.jpg');
figure(1);
imshow(I);
suptitle('原图');
I_gray = rgb2gray(I);
Eye_R = I(58:313,65:326);
Eye_L = I(84:298,463:747);
%%
% 对右眼进行二值化和边缘检测
...
houghspace_size = size(houghspace_eye_R(a1-20:a1+10,b1-20:b1+10,:));
max_hough = max(max(max(houghspace_eye_R(a1-20:a1+10,b1-20:b1+10,:))));
index = find(houghspace_eye_R(a1-20:a1+10,b1-20:b1+10,:) == max_hough);
[a2,b2,r2] = ind2sub([30,20,houghspace_size(3)],index);
a2 = a2 + a1 - 20;
b2 = b2 + b1 - 20;
r2 = r2+rmin;
x = a2 + r2*cos(alpha);
...
total_mask(58:313,65:326) = eye_R_mask;
total_mask(84:298,463:747) = eye_L_mask;
new_I = im2double(I);
