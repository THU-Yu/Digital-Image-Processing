I = im2double(imread('.\Data\23_2.bmp'));
...
title("仅有指纹区");
imwrite(NewI, ".\Data\23_2_with_mask.bmp");
%%
...
title("没有平滑的方向图");
imwrite(orientimage, ".\Data\23_2_orientimage.bmp");
%%
% 对Sin图、Cos图和频率图做空域平滑
h = ones(3,3) ./ 9;
Sin = imfilter(Sin, h);
...
title("平滑后的方向图");
imwrite(orientimage, ".\Data\23_2_orientimage_smoothing.bmp");
subplot(2,3,5);imshow(filterimage);
title("刚滤波完的图");
imwrite(filterimage, ".\Data\23_2_filterimage.bmp");
%%
% 进行亮度调整
...
title("亮度增强图");
imwrite(newfilterimage, ".\Data\23_2_filterimage_final.bmp");